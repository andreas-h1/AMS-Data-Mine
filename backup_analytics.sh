...
POSTGRES_DB=analytics_team                 # Replace with the database you want to back up
BACKUP_DIR=/home/ams/postgres/backups_analytics          # Directory to store backup files
